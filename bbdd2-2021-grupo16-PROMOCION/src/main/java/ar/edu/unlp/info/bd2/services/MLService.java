...
public interface MLService extends MLStatisticsService {
	...
	/**
	 * Servicios de borrado, reciben una entidad y lo borran permanentemente
	 * 	 
	 */
	
	/**
	 * @param category a borrar
	 */
	void deleteCategory(Category category);
	
	/**
	 * @param product a borrar
	 */
	...
	/**
	  * @param provider a borrar
	 */
	void deleteProvider(Provider provider);
	
	/**
	  * @param deliveryMethod a borrar
	 */
	void deleteDeliveryMethod(DeliveryMethod deliveryMethod);
	
	/**
	  * @param creditCardPayment a borrar
	 */
	void deleteCreditCardPayment(CreditCardPayment creditCardPayment);
	
	/**
	  * @param onDeliveryPayment a borrar
	 */
	void deleteOnDeliveryPayment(OnDeliveryPayment onDeliveryPayment);
	
	/**
	 * @param productOnSale a borrar
	 */
	void deleteProductOnSale(ProductOnSale productOnSale);
	
	/**
	 * @param purchase a borrar 
	 */
	void deletePurchase(Purchase purchase);
	/**
	 *Borra todos los datos de elastic 
	 */
	void deleteData();
	Boolean existsData();
