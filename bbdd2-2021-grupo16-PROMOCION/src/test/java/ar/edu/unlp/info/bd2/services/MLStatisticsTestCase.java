...
import ar.edu.unlp.info.bd2.config.SpringDataElasticsearchConfiguration;
...
@ContextConfiguration(classes = {
		SpringDataElasticsearchConfiguration.class }, loader = AnnotationConfigContextLoader.class)
...
public class MLStatisticsTestCase {
	...
	/*
	 * @AfterAll public void deleteData() { this.service.deleteData(); }
	 */
	...
	public void testGetUsersSpendingMoreThan() {
		...
		assertEquals(3, users.size());
		this.assertListEquality(users.stream().map(property -> property.getEmail()).collect(Collectors.toList()), Arrays
				.asList("santiagoserrano157@yahoo.com", "santiagomartin638@yahoo.com", "florenciaalonso505@yahoo.com"));
	}
	...
	public void testGetTop3MoreExpensiveProducts() {
		...
		this.assertListEquality(products.stream().map(property -> property.getName()).collect(Collectors.toList()),
	...
	public void testGetTopNUsersMorePurchase() {
		...
		this.assertListEquality(users.stream().map(property -> property.getEmail()).collect(Collectors.toList()),
				Arrays.asList("silviasez428@gmail.com", "matiasherrero831@gmail.com", "santiagoserrano157@yahoo.com",
						"silviaromero99@me.com", "florenciaalonso505@yahoo.com", "paulacaballero154@yahoo.com",
	...
	public void testGetSoldProductsOn() throws ParseException {
		...
		this.assertListEquality(
				products.stream().map(property -> property.getProduct().getName()).collect(Collectors.toList()),
				Arrays.asList("Anafe eléctrico Ultracomb AN-2211  negro 220V",
						"Cocina Escorial Candor S2  multigas 4 hornallas  blanca 220V puerta  con visor",
